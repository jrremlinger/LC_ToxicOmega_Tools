...
namespace ToxicOmega_Tools.Patches
{
    ...
    internal class RoundManagerPatch
    {
        ...
        private static List<SpawnableEnemyWithRarity> FixInsideEnemySpawns()
        {
            ...
            if (dressGirlRef != null) { dressGirlSpawnable.enemyType = dressGirlRef.enemyType; }
            ...
            if (flowermanRef != null) { flowermanSpawnable.enemyType = flowermanRef.enemyType; }
            ...
            if (hoarderRef != null) { hoarderSpawnable.enemyType = hoarderRef.enemyType; }
            ...
            if (maskedRef != null) { maskedSpawnable.enemyType = maskedRef.enemyType; }
        ...
        private static List<SpawnableEnemyWithRarity> FixOutsideEnemySpawns()
        {
            ...
            if (docileLocustRef != null) { docileLocustSpawnable.enemyType = docileLocustRef.enemyType; }
            ...
            if (doublewingRef != null) { doublewingSpawnable.enemyType = doublewingRef.enemyType; }
            ...
            if (forestGiantRef != null) { forestGiantSpawnable.enemyType = forestGiantRef.enemyType; }
            ...
            if (mouthDogRef != null) { mouthDogSpawnable.enemyType = mouthDogRef.enemyType; }
            ...
            if (redLocustRef != null) { redLocustSpawnable.enemyType = redLocustRef.enemyType; }
